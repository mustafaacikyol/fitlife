                    ...
                    <?php
                        if (isset($_POST["updateBtn"])) {
                            ...
                            if ($_POST["password"] == "" and $_POST["password_again"] == "") {
                                ...
                                $update_result = $update->execute(array("id" => $_GET["id"], "name" => $_POST["name"], "surname" => $_POST["surname"], "birthdate" => $_POST["birthdate"], "gender" => $_POST["gender"], "email" => $_POST["email"], "phone_number" => $_POST["phone_number"], "expertise_id"=>$_POST["expertise"]));
                                ...
                                if ($_POST["password"] !== $_POST["password_again"]) {
                                    ...
                                    $update_result = $update->execute(array("id" => $_GET["id"], "name" => $_POST["name"], "surname" => $_POST["surname"], "birthdate" => $_POST["birthdate"], "gender" => $_POST["gender"], "email" => $_POST["email"], "phone_number" => $_POST["phone_number"], "password" => md5($_POST["password"]), "expertise_id"=>$_POST["expertise"]));
